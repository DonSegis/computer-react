    ...
    <div className="body-legal">
      ...
      <div class="container-legal">
        ...
        <p>
          ...
          Computer usa y protege la información que es proporcionada por sus
        ...
        <br />
        <p>
          Computer Computación está altamente comprometido para cumplir con el
        ...
        <br />
        <p>
          Computer Computación Se reserva el derecho de cambiar los términos de
